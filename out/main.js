...
if (process.argv.length === 2) {
  console.log();
  console.log('用法：');
  console.log('   layanative3 createapp [OPTIONS]');
  console.log('   layanative3 refreshres [OPTIONS]');
  console.log('   layanative3 removeres [OPTIONS]');
  console.log('   layanative3 listversions');
  console.log('描述：');
  console.log('   createapp');
  console.log('       创建一个runtime项目。');
  console.log('       具体帮助信息用 layanative3 createapp --help 查看。');
  console.log('   refreshres');
  console.log('       刷新当前目录对应的项目的资源。');
  console.log('       具体帮助信息用 layanative3 refreshres --help 查看。');
  console.log('   removeres');
  console.log('       删除当前目录对应的项目的资源。');
  console.log('       具体帮助信息用 layanative3 removeres --help 查看。');
  console.log('   listversions');
  console.log('       列出所有可用SDK版本。');
  console.log('       具体帮助信息用 layanative3 listversions --help 查看。');
  return;
}
